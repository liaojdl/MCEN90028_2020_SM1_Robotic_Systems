function [Xi,Yi,Xf,Yf,tSegx] = GetnewXY_init_task2(Lbd,Ldc,pA,pB,pC,pD,tSeg,mode)
...
switch mode
    case 'smooth'
        ...
        Xi = [pA(1),pB(1),pD(1);0,0.25,(vxBD+vxDC)/2];
        Xf = [pB(1),pD(1),pC(1);0.25,(vxBD+vxDC)/2,0];
        Yi = [pA(2),pB(2),pD(2);0,0.25,(vyBD+vyDC)/2];
        Yf = [pB(2),pD(2),pC(2);0.25,(vyBD+vyDC)/2,0];
    case 'straight'
        Xi = [pA(1),pB(1),pD(1);0,0.25,0];
        Xf = [pB(1),pD(1),pC(1);0.25,0,0];
        Yi = [pA(2),pB(2),pD(2);0,0.25,0];
        Yf = [pB(2),pD(2),pC(2);0.25,0,0];
end
