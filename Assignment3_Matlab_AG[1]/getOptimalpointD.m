function [D1validity,D2validity] = getOptimalpointD(pD1,pD2,pO,ro,L1,L2,origin)
...
%% get ik solution at point B and C
[qBup,qBdown]=ik2d2link(pD1(1)-origin(1),pD1(2)-origin(2),L1,L2);
[qCup,qCdown]=ik2d2link(pD2(1)-origin(1),pD2(2)-origin(2),L1,L2);
...
L2_Bup = [linspace(J2x_Bup,pD1(1),NL1);linspace(J2y_Bup,pD1(2),NL2)];
L2_Bdown = [linspace(J2x_Bdown,pD1(1),NL1);linspace(J2y_Bdown,pD1(2),NL2)];
L2_Cup = [linspace(J2x_Cup,pD2(1),NL1);linspace(J2y_Cup,pD2(2),NL2)];
L2_Cdown = [linspace(J2x_Cdown,pD2(1),NL1);linspace(J2y_Cdown,pD2(2),NL2)];
...
%% outputting
D1validity = 'none';
if (D1Conup == 0 && D1Condown == 0)
    D1validity = 'both';
elseif (D1Conup == 1 && D1Condown == 0)
    D1validity = 'down';
elseif (D1Conup == 0 && D1Condown == 1)
    D1validity = 'up';
end

D2validity = 'none';
if (D2Conup == 0 && D2Condown == 0)
    D2validity = 'both';
elseif (D2Conup == 1 && D2Condown == 0)
    D2validity = 'down';
elseif (D2Conup == 0 && D2Condown == 1)
    D2validity = 'up';
end